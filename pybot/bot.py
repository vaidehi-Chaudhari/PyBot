...
Introduce_Ans = ["My name is FaqBot.","My name is FaqBot you can called me pi.","Im FaqBot :) ","My name is FaqBot. and my nickname is pi and i am happy to solve your queries :) "]
